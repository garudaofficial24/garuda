...
const EditQuotation = () => {
  ...
  return (
    <div data-testid="edit-quotation-page">
      <div className="mb-6">
        <Button
          variant="ghost"
        ...
        <h1 className="text-3xl font-bold text-slate-800 mb-2">Edit Quotation</h1>
        <p className="text-slate-600">Update the quotation details</p>
      </div>
