...
const CreateInvoice = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.invoice_number || !formData.company_id || !formData.client_name) {
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <Select 
                    key={`currency-${formData.currency || 'IDR'}`} value={formData.currency || "IDR"} 
                ...
                <div>
                  ...
                  <Select 
                    key={`status-${formData.status || 'draft'}`} value={formData.status || "draft"} 
                  ...
                  {invoiceItems.map((item, index) => (
                    <div key={index} className="border rounded-lg p-4 space-y-3">
                      ...
                      <div>
                        ...
                        <Select 
                          key={`item-select-${index}-${item.item_id || 'empty'}`} value={item.item_id || ""} 
